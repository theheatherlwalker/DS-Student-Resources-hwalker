...
#==============================================================================
# QUESTION SETUP
  # One of the quintessential debates in Star Wars fandom is whether 
    # you are a fan of episodes I, II, and III (the newer, 
    # second trilogy of movies) or a fan of episodes IV, V, and VI 
    # (the older, beginning trilogy of movies).
  # In this Chi-Square, you will determine whether age category Age influences
    # someone's ranking of Episode I: The Phantom Menace.
